...
/obj/effect/overmap/trade_beacon/alphaquad // alpha quad
	...
	possible_imports = list(
		...
		/datum/beacon_import/clothing/accessory/holster/thigh = 100, // military
		/datum/beacon_import/clothing/accessory/webbing_large = 70, // military
		/datum/beacon_import/clothing/accessory/storage/vest = 70, // military
		...
		/datum/beacon_import/clothing/accessory/storage/pcarrier = 100, // military
		/datum/beacon_import/clothing/accessory/storage/platemedium = 70, // military
		/datum/beacon_import/clothing/accessory/storage/merc = 50, // military
		/datum/beacon_import/clothing/storage/backpack/dufflebag/sec = 40, // military
		/datum/beacon_import/clothing/storage/backpack/dufflebag/sec = 40, // military
...
/obj/effect/overmap/trade_beacon/terrantitan // beta quad
	...
	possible_imports = list(
		...
		/datum/beacon_import/clothing/accessory/holster = 60, // military
		...
		/datum/beacon_import/clothing/accessory/storage/merc = 50,
		/datum/beacon_import/bluespacecrystal_mid = 60,
		/datum/beacon_import/bluespacecrystal_high = 60
	)
...
/obj/effect/overmap/trade_beacon/dredward // hopeful landing
	...
	possible_imports = list(
		...
		/datum/beacon_import/clothing/suit/medical_chest_rig = 100, // job medic
		/datum/beacon_import/clothing/suit/surgicalapron = 100, // job medic
		/datum/beacon_import/clothing/suit/hospital = 100, // job medic
		/datum/beacon_import/clothing/accessory/stethoscope = 100, // job medic
		...
		/datum/beacon_import/clothing/under/medical = 80, // job medic
		/datum/beacon_import/clothing/under/medical/paramedic = 40, // job medic
		/datum/beacon_import/clothing/under/scrubs = 100, // job medic
		/datum/beacon_import/clothing/under/psych = 40, // job medic
		/datum/beacon_import/clothing/under/sterile = 100, // job medical
...
/obj/effect/overmap/trade_beacon/jupitersoutpost // southern rim
	...
	possible_imports = list(
		...
		/datum/beacon_import/clothing/under/internalaffairs = 100, // fun
		/datum/beacon_import/clothing/under/lawyer = 100, // fun
