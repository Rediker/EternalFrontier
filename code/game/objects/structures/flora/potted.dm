...
/obj/structure/flora/pottedplant // Credit to flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
	name         = "decrepit pot"
...
/obj/structure/flora/pottedplant/sappling // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/sappling/oak // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/sappling/greatoak // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/sappling/cecropia // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/sappling/birch // Credit to Crimsonerva for complete sprite. Credit to Flashkirby for inspiration.
...
/obj/structure/flora/pottedplant/sappling/spruce // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/sappling/willow // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/sappling/palm // Credit to Crimsonerva for complete sprite.
	name         = "potted palmtree "
	desc         = "Reminds of you some tropical resort. Has some budding coconuts."
	icon_state   = "palm_sappling"
	w_class      = ITEM_SIZE_LARGE

/obj/structure/flora/pottedplant/sappling/judean // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/sappling/cherry // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/sappling/fern // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/sappling/rose // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/shrub/yew // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/shrub/heart // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
	name         = "potted heart-trimmed shrub"
	desc         = "A very loving shrub, trimmed in such a way to form a heart."
	icon_state   = "heart_shrub"
	w_class      = ITEM_SIZE_LARGE

/obj/structure/flora/pottedplant/shrub/holly // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/shrub/typical // Credit to Crimsonerva for complete sprite.
	name         = "potted shrub"
...
/obj/structure/flora/pottedplant/shrub/perfect // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/shrub/rose // Original sprite creator DoctorRay2. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/shrub/autumn // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/shrub/roses // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/desert // Credit to Crimsonerva for complete sprite.
	name         = "empty dry pot"
	desc         = "A barren pot, meant for a dry plant."
	icon_state   = "desert_pot"
	w_class      = ITEM_SIZE_NORMAL

/obj/structure/flora/pottedplant/desert/pear // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
	name         = "potted prickily pear"
	desc         = "A potted cactus, with budding fruits. They smell sour."
	icon_state   = "pear_desert"
	w_class      = ITEM_SIZE_LARGE

/obj/structure/flora/pottedplant/desert/tall // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
	name         = "potted tall cactus"
	desc         = "A tall catus. It never seems thirsty."
	icon_state   = "tall_desert"
	w_class      = ITEM_SIZE_LARGE

/obj/structure/flora/pottedplant/desert/short // Credit to Crimsonerva for complete sprite. Credit to Flashkirby for inspiration.
	name         = "potted short cactus"
	desc         = "A short catus. It always seems thirsty."
	icon_state   = "short_desert"
	w_class      = ITEM_SIZE_LARGE

/obj/structure/flora/pottedplant/desert/barrel // Credit to Crimsonerva for complete sprite.
	name         = "potted barrel cactus"
	desc         = "A barrel catus. You can never tell if it is thirsty."
	icon_state   = "barrel_desert"
	w_class      = ITEM_SIZE_LARGE

/obj/structure/flora/pottedplant/desert/aloe // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/xenoflora // Credit to Crimsonerva for complete sprite.
	...
	w_class      = ITEM_SIZE_NORMAL
/obj/structure/flora/pottedplant/xenoflora/crystalline // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
	...
	w_class      = ITEM_SIZE_LARGE
/obj/structure/flora/pottedplant/xenoflora/crystalline/Initialize()
	. = ..()
	set_light(l_range = 2, l_power = 0.5, l_color = "#4997d8")

/obj/structure/flora/pottedplant/xenoflora/bulbous // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
	...
	w_class      = ITEM_SIZE_LARGE
/obj/structure/flora/pottedplant/xenoflora/bulbous/Initialize()
	. = ..()
	set_light(l_range = 2, l_power = 0.5, l_color = "#4997d8")

/obj/structure/flora/pottedplant/xenoflora/giantflower // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/xenoflora/sticky // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/xenoflora/pitcher // Credit to Flashkirby for original sprite. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/xenoflora/mushroom1 // Original sprite creator unknown. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/xenoflora/mushroom2 // Original sprite creator unknown. Credit to Crimsonerva for editing and corrections.
	name         = "potted giant mushroom"
...
/obj/structure/flora/pottedplant/xenoflora/mushroom3 // Original sprite creator unknown. Credit to Crimsonerva for editing and corrections.
	name         = "potted giant mushroom"
...
/obj/structure/flora/pottedplant/xenoflora/vines1 // Original sprite creator unknown. Credit to Crimsonerva for editing and corrections.
...
/obj/structure/flora/pottedplant/xenoflora/vines2 // Original sprite creator unknown. Credit to Crimsonerva for editing and corrections.
	name         = "potted hardened vine"
	desc         = "An exotic vine. This vine has many loops and turns, and it looks very confusing to the human eye. You fail to make out what each part even does..."
	icon_state   = "vine2_xenoflora"
	w_class      = ITEM_SIZE_LARGE

/obj/structure/flora/pottedplant/xenoflora/orb // Original sprite creator unknown. Credit to Crimsonerva for editing and corrections.
	name         = "potted giant orb"
	desc         = "An exotic orb... plant. Its orb looks squishy. Best not to pop it."
	icon_state   = "orb_xenoflora"
	w_class      = ITEM_SIZE_LARGE
/obj/structure/flora/pottedplant/xenoflora/orb/Initialize()
	. = ..()
...
// ### FUTURISTIC ###
// ### ########## ###
/obj/structure/flora/pottedplant/futuristic // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/futuristic/Initialize() // all holographic pots & plants should emit a glow
	. = ..()
...
/obj/structure/flora/pottedplant/floral2/chrysanthemum // Credit to Crimsonerva for complete sprite.
...
/obj/structure/flora/pottedplant/floral2/rose // Credit to Crimsonerva for complete sprite.
	name         = "a cut rose"
